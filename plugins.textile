...
Two or more jobs with the same lock cannot be processed simultaneously by two or more workers. When this situation occurs the second job gets pushed back to the queue.
...
* "gip / resque-telework":https://github.com/gip/resque-telework
...
Show history of recently executed resque jobsqueues
